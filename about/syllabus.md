...
To be clear, the UBCO Bookstore has three options: 
1) eText with Mastering Physics access code (\$115.50 + tax), 
2) Physical textbook with Mastering Physics access code (\$150 + tax), 
3) Mastering Physics access code only (\$50.50 + tax). 
 
Most students will choose choose Option 1.
